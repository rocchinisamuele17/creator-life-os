...
export const SEED_STATE: AppState = {
  ...
  goals: [
    { goal: "Raggiungere 100K follower su TikTok", progress: 65 },
    { goal: "Lanciare il nuovo Corso AI per Creator", progress: 85 },
    { goal: "Chiudere 3 Brand Deal da +5.000€", progress: 33 },
    { goal: "Pubblicare 90 contenuti originali", progress: 52 },
  ],
  journal: [],
  reminders: [
